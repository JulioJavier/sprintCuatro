...
import ButtonLogout from "../layout/ButtonLogout";
  ...
  return (
    <div className="flex w-screen h-screen items-center justify-center pb-28 md:pb-11">
      <div className="flex w-full h-full flex-col items-center p-2 md:w-1/2  gap-1 md:justify-center">
        ...
        <div className="w-full h-16 rounded-xl flex items-center pl-2 pr-2 justify-between hover:bg-yellow-100 md:w-full cursor-pointer">
